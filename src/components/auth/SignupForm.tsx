          ...
          field
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <FormControl>
                      <input type="text" placeholder="Your first name" className="pl-10 w-full p-3 border-none rounded-md focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-600 bg-sky-200" />
                    </FormControl>
                  </div>
