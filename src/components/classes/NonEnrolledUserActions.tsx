...
export function NonEnrolledUserActions({ class_, isSessionActive }: NonEnrolledUserActionsProps) {
  const { handleJoinLiveClass } = useLiveSession();
  const { isEnrolling, enrollmentSuccess, handleEnroll } = useClassEnrollment(class_);
